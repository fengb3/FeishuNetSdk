...
namespace FeishuNetSdk.FeishuEvent.V2.Vc.Meeting
{
    /// <summary>
    /// 结束屏幕共享<br/>
    /// 发生在屏幕共享结束时【仅通过Open API预约的会议会产生此类事件】<br/>
    /// </summary>
    /// <事件类型> vc.meeting.share_ended_v1 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/share_ended">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取会议信息 </li>
    /// </ul>
    ...
    /// </ul>
    /// </字段权限要求>
    public class ShareEndedV1 : EventContext<ShareEndedV1.EventData>
    {
