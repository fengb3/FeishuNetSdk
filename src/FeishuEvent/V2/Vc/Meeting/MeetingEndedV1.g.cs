...
namespace FeishuNetSdk.FeishuEvent.V2.Vc.Meeting
{
    /// <summary>
    /// 会议结束<br/>
    /// 发生在会议结束时【仅通过Open API预约的会议会产生此类事件】<br/>
    /// </summary>
    /// <事件类型> vc.meeting.meeting_ended_v1 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/meeting_ended">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取会议信息 </li>
    /// </ul>
    ...
    /// </ul>
    /// </字段权限要求>
    public class MeetingEndedV1 : EventContext<MeetingEndedV1.EventData>
    {
