...
namespace FeishuNetSdk.FeishuEvent.V2.Im.Chat
{
    ...
    /// 群组被解散后触发此事件。<br/>
    /// </summary>
    /// <事件类型> im.chat.disbanded_v1 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat/events/disbanded">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取与更新群组信息 </li>
    /// <li> 获取群组信息 </li>
    ...
    /// </ul>
    /// </字段权限要求>
    public class DisbandedV1 : EventContext<DisbandedV1.EventData>
    {
