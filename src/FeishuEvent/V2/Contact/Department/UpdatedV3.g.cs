...
namespace  FeishuNetSdk.FeishuEvent.V2.Contact.Department
{
    /// <summary>
    /// 修改部门信息<br/>
    /// 通过该事件订阅部门更新。old_object只展示被更新字段的原始值。应用身份访问通讯录的权限为历史版本，不推荐申请。<br/>
    /// </summary>
    /// <事件类型> contact.department.updated_v3 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/events/updated">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取通讯录基本信息 </li>
    /// <li> 以应用身份读取通讯录 </li>
    ...
    public class UpdatedV3 : EventContext<UpdatedV3.EventData>
    {
        ...
        public class EventData
        {
            ...
            public DepartmentEvent OldObject { get; init; }
        }
