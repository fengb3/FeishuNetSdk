...
namespace FeishuNetSdk.FeishuEvent.V2.Contact.Department
{
    /// <summary>
    /// 创建部门<br/>
    /// 创建通讯录部门时发送该事件给订阅应用。<br/>
    /// </summary>
    /// <事件类型> contact.department.created_v3 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/department/events/created">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取通讯录基本信息 </li>
    /// <li> 以应用身份读取通讯录 </li>
