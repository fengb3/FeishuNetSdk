...
namespace FeishuNetSdk.FeishuEvent.V2.Contact.EmployeeTypeEnum
{
    ...
    /// 停用人员类型会发出对应事件。<br/>
    /// </summary>
    /// <事件类型> contact.employee_type_enum.deactivated_v3 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/events/deactivated">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取通讯录基本信息 </li>
    /// <li> 以应用身份读取通讯录 </li>
    ...
    /// 无
    /// </字段权限要求>
    public class DeactivatedV3 : EventContext<DeactivatedV3.EventData>
    {
