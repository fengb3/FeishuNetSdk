...
namespace FeishuNetSdk.FeishuEvent.V2.Contact.EmployeeTypeEnum
{
    ...
    /// 新建人员类型会发出对应事件。<br/>
    /// </summary>
    /// <事件类型> contact.employee_type_enum.created_v3 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/contact-v3/employee_type_enum/events/created">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取通讯录基本信息 </li>
    /// <li> 以应用身份读取通讯录 </li>
    ...
    {
        // EventData|new_enum:employee_type_enum|enum_id:string||enum_value:string||content:string||enum_type:int||enum_status:int||i18n_content:i18n_content|locale:string||value:string|
