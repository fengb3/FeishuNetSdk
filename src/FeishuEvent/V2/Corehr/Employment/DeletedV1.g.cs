...
namespace FeishuNetSdk.FeishuEvent.V2.Corehr.Employment
{
    /// <summary>
    /// 【事件】删除雇佣信息<br/>
    /// 员工在飞书人事的「雇佣信息被删除」时将触发此事件。<br/>
    /// </summary>
    /// <事件类型> corehr.employment.deleted_v1 </事件类型>
    /// <事件版本> V2.0 </事件版本>
    /// <自建应用> 支持 </自建应用>
    /// <商店应用> 支持 </商店应用>
    /// <文档链接> <a href="https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/employment/events/deleted">在open.feishu.cn中查看</a> </文档链接>
    /// <权限要求>
    /// <ul>
    /// <li> 获取核心人事信息 </li>
    /// <li> 获取雇佣信息 </li>
